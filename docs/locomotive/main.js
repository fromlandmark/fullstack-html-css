!(function (t, e) {
	"object" == typeof exports && "undefined" != typeof module
		...
		? define(e)
		: ((t = "undefined" != typeof globalThis ? globalThis : t || self).LocomotiveScroll = e());
})(this, function () {
	"use strict";
	function t(t, e) {
							...
							if (this.reloadOnContextChange) {
								...
								if (
									...
									("desktop" == t ? this.smooth : this[t].smooth) !=
										("desktop" == this.context ? this.smooth : this[this.context].smooth) && window.location.reload();
							}
						},
					},
					{
				...
				polyfill: function () {
						...
						(t.scroll = t.scrollTo =
							...
							(s.prototype.scrollIntoView = function () {
								if (!0 !== a(arguments[0])) {
									...
									i !== e.body
										? (p.call(this, i, i.scrollLeft + o.left - s.left, i.scrollTop + o.top - s.top),
					...
					function p(i, s, l) {
						var a,
							...
							u = o();
						i === e.body
							? ((a = t), (c = t.scrollX || t.pageXOffset), (h = t.scrollY || t.pageYOffset), (d = n.scroll))
							...
							value: function (t) {
								...
								if (t)
									for (var i = 0; i < t.length; i++)
										"string" == typeof t[i]
											? t[i].includes("%")
												? (e[i] = parseInt((t[i].replace("%", "") * this.windowHeight) / 100))
												: (e[i] = parseInt(t[i]))
											: (e[i] = t[i]);
								return e;
							},
						...
						(t.prototype.check = function (t) {
							...
							return (
								...
								e > 0
									...
									: (this.lastDownDeltas.push(e), this.lastDownDeltas.shift(), this.isInertia(-1))
							);
						}),
	...
	(V.prototype._notify = function (t) {
		...
		(V.prototype._unbind = function () {
			M.hasWheelEvent && this.el.removeEventListener("wheel", this._onWheel),
				...
				M.hasTouch &&
					(this.el.removeEventListener("touchstart", this._onTouchStart), this.el.removeEventListener("touchmove", this._onTouchMove)),
				M.hasPointer &&
					M.hasTouchWin &&
				...
				i(n, [
					{
						...
						value: function () {
							...
							this.html.classList.add(this.smoothClass),
								...
								(this.instance = o(
									{ delta: { x: this.initPosition.x, y: this.initPosition.y }, scroll: { x: this.initPosition.x, y: this.initPosition.y } },
									this.instance
								)),
								(this.vs = new R({
									...
									case nt:
										requestAnimationFrame(function () {
											(e.html.scrollTop = 0),
												...
												e.scrollTo(document.activeElement, { offset: -window.innerHeight / 2 });
										});
										break;
									case et:
							...
							if (e || this.isScrolling || this.isDraggingScrollbar) {
								...
								if (
									(!this.animatingScroll &&
										s > 100 &&
										((i < 0.5 && 0 != this.instance.delta[this.directionAxis]) ||
											(i < 0.5 && 0 == this.instance.delta[this.directionAxis])) &&
										this.stopScrolling(),
									Object.entries(this.sections).forEach(function (i) {
										var s = f(i, 2),
											n = (s[0], s[1]);
										n.persistent ||
										(t.instance.scroll[t.directionAxis] > n.offset[t.directionAxis] &&
											t.instance.scroll[t.directionAxis] < n.limit[t.directionAxis])
											? ("horizontal" === t.direction
													? t.transform(n.el, -t.instance.scroll[t.directionAxis], 0)
													: t.transform(n.el, 0, -t.instance.scroll[t.directionAxis]),
											  n.inView ||
													((n.inView = !0),
													(n.el.style.opacity = 1),
													(n.el.style.pointerEvents = "all"),
													n.el.setAttribute("data-".concat(t.name, "-section-inview"), "")))
											: ((n.inView || e) &&
													((n.inView = !1),
							...
							(this.hasScrollbar = !0),
								...
								"horizontal" === this.direction
									? (this.scrollbarThumb.style.width = "".concat(
											(this.scrollbarWidth * this.scrollbarWidth) / (this.instance.limit.x + this.scrollbarWidth),
											"px"
									  ))
									: (this.scrollbarThumb.style.height = "".concat(
											(this.scrollbarHeight * this.scrollbarHeight) / (this.instance.limit.y + this.scrollbarHeight),
											"px"
									  )),
						...
						value: function () {
							...
							(this.els = {}),
								...
								this.el.querySelectorAll("[data-".concat(this.name, "]")).forEach(function (e, i) {
									...
									null === r || r.inView
										? ((s = w.top + t.instance.scroll.y - q(o).y), (n = w.left + t.instance.scroll.x - q(o).x))
										: ((s = w.top - q(r.el).y - q(o).y), (n = w.left - q(r.el).x - q(o).x));
									...
									if (b)
										if ("horizontal" === t.direction) {
											for (var C = 0; C < b.length; C++)
												"string" == typeof b[C]
													? b[C].includes("%")
														? (D[C] = parseInt((b[C].replace("%", "") * t.windowWidth) / 100))
														: (D[C] = parseInt(b[C]))
													: (D[C] = b[C]);
											(n += D[0]), (x -= D[1]);
										} else {
											for (C = 0; C < b.length; C++)
												"string" == typeof b[C]
													? b[C].includes("%")
														? (D[C] = parseInt((b[C].replace("%", "") * t.windowHeight) / 100))
														: (D[C] = parseInt(b[C]))
													: (D[C] = b[C]);
											(s += D[0]), (S -= D[1]);
										}
						...
						value: function (t) {
							...
							Object.entries(this.parallaxElements).forEach(function (l) {
								...
								a.sticky &&
									...
									!1 !== c &&
										("horizontal" === a.direction || ("horizontal" === e.direction && "vertical" !== a.direction)
						...
						value: function (t) {
							...
							var S = Date.now(),
								x = function t() {
									var i = (Date.now() - S) / n;
									i > 1
										? (w(1), (e.animatingScroll = !1), 0 == n && e.update(), r && r())
